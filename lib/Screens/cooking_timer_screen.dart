...
class _CookingTimerScreenState extends State<CookingTimerScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final progress = _completedSteps.isEmpty ? 0.0 : completedCount / _completedSteps.length.toDouble();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          'Step ${_currentStepIndex + 1} of ${widget.instructions.length}',
                          style: GoogleFonts.inter(
                            fontSize: 16,
                            fontWeight: FontWeight.w700,
                            color: const Color(0xFF243447),
                        ...
                        Text(
                          '$completedCount / ${widget.instructions.length} done',
                          style: GoogleFonts.inter(
                            fontSize: 13,
                            color: Colors.grey[600],
                          ),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          Text(
                            widget.instructions[_currentStepIndex],
                            style: GoogleFonts.inter(
                              fontSize: 15,
                              color: const Color(0xFF5F6B78),
                              height: 1.6,
                          ...
                          SizedBox(
                            width: double.infinity,
                            child: _currentStepIndex == widget.instructions.length - 1
                                ? ElevatedButton.icon(
                                    style: ElevatedButton.styleFrom(
                                      backgroundColor: const Color(0xFF13EC5B),
                                ...
                                : ElevatedButton.icon(
                                    ...
                                    onPressed: () => _markStepComplete(_currentStepIndex),
                                    icon: Icon(
                                      _completedSteps[_currentStepIndex]
                                          ? Icons.check_circle
